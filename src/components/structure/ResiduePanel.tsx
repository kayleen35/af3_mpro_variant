        ...
        {metrics ? (
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="p-2.5 rounded-lg bg-[#141b2d] border border-[#243047]">
              <span className="text-gray-400 block text-[10px] font-mono">Cys145 Proximity</span>
            ...
            <div className="p-2.5 rounded-lg bg-[#141b2d] border border-[#243047]">
              <span className="text-gray-400 block text-[10px] font-mono">H-Bond Network</span>
            ...
            {metrics.a166f167Interaction && (
              <div className="col-span-2 p-2.5 rounded-lg bg-[#141b2d] border border-[#243047]">
                <span className="text-gray-400 block text-[10px] font-mono">E166/F167 Interaction</span>
          ...
          {RESIDUE_PANEL_GROUPS.map((group) => (
            <div key={group.groupName} className="p-3 rounded-xl bg-[#111827] border border-[#243047]">
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-[10px] font-mono text-gray-500">{group.residues.length} AA</span>
              </div>
              <p className="text-[10px] text-gray-400 mb-2 leading-relaxed">{group.description}</p>

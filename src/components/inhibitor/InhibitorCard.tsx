      ...
      <div className="flex items-start gap-3 flex-1">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[14px] px-2 py-0.5 rounded font-mono bg-violet-950/50 text-violet-300 border border-violet-500/30">
              Ligand
            </span>
          </div>
          ...
          {inhibitor.developmentStatusLabel && (
            <div className="mt-2.5 pt-2 border-t border-[#243047]/60 flex items-center gap-1.5 text-[14px] text-gray-500 font-mono">

                    ...
                    {item.bindingAffinity !== undefined ? (
                      <div className="flex items-center gap-2">
                        ...
                        {item.bindingAffinityDelta !== undefined && (
                          <span className={`text-[13px] font-bold ${formatDelta(item.bindingAffinityDelta).className}`}>
              ...
              {item.nasal.solubility && (
                <div className="mt-3 pt-3 border-t border-[#243047]">
                  ...
                  <div className="flex items-baseline gap-2 flex-wrap">
                    ...
                    <span className={`text-[13px] font-bold ${item.nasal.solubility.sufficient ? 'text-emerald-400' : 'text-amber-400'}`}>
